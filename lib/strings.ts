...
const STRINGS = {
  ...
  game: {
    ...
    lobbyRoundNote:
      'New round every 30 seconds · simulated results generated by a deterministic algorithm seeded per period. Demo only — no real money.',
  },
  ...
  lobby: {
    ...
    welcomeHeadline: 'First deposit +200%',
    welcomeSub: 'Up to 5,000 USDT bonus + 3 free spins',
    claimBonus: 'Claim bonus',
    totalBalance: 'TOTAL BALANCE',
    mainWallet: 'Main wallet',
    winningsWallet: 'Winnings wallet',
    bonusWallet: 'Bonus wallet',
    referralWallet: 'Referral wallet',
    games: 'Games',
    liveWinners: 'Live winners',
    latest: 'Wingo 30s · latest',
    playNow: 'Play now',
    live: 'LIVE',
  },
